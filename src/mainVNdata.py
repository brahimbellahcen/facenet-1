...
def main():
    ...
    split_data(data_dir +'embeddings_X_y.npz', 0.8, data_dir + 'embeddings_Xtr_ytr_Xt_yt_0.8.npz')
    

    train_SVM(
        data_dir + 'embeddings_Xtr_ytr_Xt_yt_0.8.npz',
        CONSTANTS.root + '/model/SVM_FR_VNCeleb_train5_0.8.joblib')
