...
def main():
    ...
    split_data(data_dir +'embeddings_X_y.npz', 20, data_dir + 'embeddings_Xtr_ytr_Xt_yt_20_pass.npz')
    

    train_SVM(
        data_dir + 'embeddings_Xtr_ytr_Xt_yt_20_pass.npz',
        CONSTANTS.root + '/model/SVM_FR_VNCeleb_train5_20_pass.joblib')
