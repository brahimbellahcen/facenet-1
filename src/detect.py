...
#return a numpy array 2X2, pixels of face, return first face
...
# return a list of faces in a directory
def extract_faces_from_dir(dir):
    faces = list()
...
# return detected faces and label as np array
def extract_faces_from_dataset(dir):
    X, y = list(), list()
    for subdir in listdir(dir):
        ...
        faces = extract_faces_from_dir(path)
